...
Recommended review path: business report → executive dashboard → reproducible analysis.

- [Read the two-page A/B testing business report](week2_checkout_experiment/reports/checkout_ab_test_business_report.pdf)
